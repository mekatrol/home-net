...
# SSH_USER_NAME="ssh" SSH_USER_PASSWORD="pwd" HOSTNAME="opensearch.example.com" \
# TIMEZONE="Australia/Sydney" CERTNAME="opensearch.example.com-rsa" ./create.sh
...
IMAGE_NAME="${IMAGE_NAME:-opensearch}"
...
# Data volume for opensearch home
...
# Build image
# Expects a Dockerfile in cwd that extends n8nio/opensearch and adds SSH user.
...
run_args=(
  ...
  -v "$DATA_VOL:/home/node/.opensearch"
...
echo "Data vol:  $DATA_VOL  -> /home/node/.opensearch"
